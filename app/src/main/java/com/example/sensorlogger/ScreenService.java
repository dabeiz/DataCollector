...
public class ScreenService extends Service {
    ...
    private void myStartForeground() {
        ...
        // 设定通知channel的 ID和名称以及重要程度, 用户可以在手机的通知管理看到通知渠道的名称
        String channelID = "ScreenServiceChannelID";
        String channelName = "屏幕状态监听";
        ...
        builder.setContentText("正在监听屏幕状态...");  // 通知内容
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.d(TAG, "Listening Screen");
        mDataRecorder.recordData(startTimeMilis + "_SCREEN", "Start record at " + SDF.format(date) + "\n");

        String strFormat = "Time\tAction\n";
        mDataRecorder.recordData(startTimeMilis + "_SCREEN", strFormat);
    ...
    public void onDestroy() {
        ...
        // 注销屏幕广播接收器, Receiver的注册与反注册需要成对出现
    ...
    public class ScreenReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            mDataRecorder.recordData(startTimeMilis + "_SCREEN", currTimeMilis + "\t" + intent.getAction() + "\n");
        }
    }
